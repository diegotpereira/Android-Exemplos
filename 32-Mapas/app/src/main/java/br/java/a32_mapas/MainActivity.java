...
import br.java.a32_mapas.db.GeofenceDB;
import br.java.a32_mapas.modelo.GeofenceInfo;
import br.java.a32_mapas.receiver.GeofenceReceiver;
import br.java.a32_mapas.task.BuscarLocalTask;
import br.java.a32_mapas.task.RotaTask;
...
public class MainActivity extends AppCompatActivity
    ...
    private void obterUltimaLocalizacao() {
        ...
        if (location != null) {
            ...
            // vamos tentar obter a última localização 10 vezes
    ...
    LoaderManager.LoaderCallbacks<List<Address>> mBuscaLocalCallback =
            new LoaderManager.LoaderCallbacks<List<Address>>() {
                @NonNull
                @Override
                public Loader<List<Address>> onCreateLoader(int i, @Nullable Bundle listLoader) {
                    return new BuscarLocalTask(MainActivity.this,
                            mEdtLocal.getText().toString());
                }

                @Override
                public void onLoadFinished(@NonNull Loader<List<Address>> listLoader,
                ...
                @Override
                public void onLoaderReset(@NonNull Loader<List<Address>> listLoader) {
                }
            };
    ...
    LoaderManager.LoaderCallbacks<List<LatLng>> mRotaCallback =
            new LoaderManager.LoaderCallbacks<List<LatLng>>() {
                ...
                @Override
                public void onLoaderReset(@NonNull Loader<List<LatLng>> listLoader) {
