...
public interface Constantes {
    ...
    String ACAO_PROXIMO = "br.java.ACAO_PROXIMO";
    String ACAO_ANTERIOR = "br.java.ACAO_ANTERIOR";
    String ACAO_DADOS_ALTERADOS = "br.java.ACAO_DADOS_ALTERADOS";
    String ACAO_SAIR = "br.java.ACAO_SAIR";
