...
public class Bolinha {
    ...
    public void calcularFisica() {
        ...
        boolean rebateEmX = false;
        boolean rebateEmY = false;
        ...
        if (rebateEmY && Math.abs(mVelocidadeY) < VELOCIDADE_MINIMA) {
            mVelocidadeY = 0;
        }
        ...
        if (rebateEmX && Math.abs(mVelocidadeX) < VELOCIDADE_MINIMA) {
