...
public class DiscoDb {
    ...
    public List<Disco> getDiscos() {
        ...
        while(cursorDiscos.moveToNext()) {
            ...
            disco.titulo = cursorDiscos.getString(cursorDiscos.getColumnIndexOrThrow(DiscoContract.COL_TITULO));
            disco.ano = cursorDiscos.getInt(cursorDiscos.getColumnIndexOrThrow(DiscoContract.COL_ANO));
            disco.capa = cursorDiscos.getString(cursorDiscos.getColumnIndexOrThrow(DiscoContract.COL_CAPA));
            disco.capaGrande = cursorDiscos.getString(cursorDiscos.getColumnIndexOrThrow(DiscoContract.COL_CAPA_BIG));
            disco.gravadora = cursorDiscos.getString(cursorDiscos.getColumnIndexOrThrow(DiscoContract.COL_GRAVADORA));

            long id = cursorDiscos.getLong(cursorDiscos.getColumnIndexOrThrow(DiscoContract._ID));
            ...
            while (cursorFormacao.moveToNext()){
                integrantes[i] = cursorFormacao.getString(cursorFormacao.getColumnIndexOrThrow(DiscoContract.COL_INTEGRANTE));
                i++;
            }
            ...
            while (cursorMusicas.moveToNext()){
                musicas[i] = cursorMusicas.getString(cursorMusicas.getColumnIndexOrThrow(DiscoContract.COL_MUSICA));
                i++;
            }
